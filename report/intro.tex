...
\leo{The reminder of this paper is organized as follows: Section~\ref{sec:}
introduces the MG algorithm briefly. Section~\ref{sec:} investigates the impact
of different parameters on the time to completion. Section~\ref{sec:} explores
precision-performance trade-offs. Section~\ref{sec:} presents an analytical
model to determine the optimal set of precisions to use. Section~\ref{sec:}
shows our evaluation and results. Section~\ref{sec:} discuss other related
works and Section~\ref{sec:} concludes this paper.}
