...
%     \includegraphics[width=\textwidth]{figs/3157_15.pdf}
   ...
   \begin{figure*}
    ...
    \caption{Cost of the MG solver considering several different dynamic accuracy cenarios to reach different accuracy degrees in the output: $10^{-3}$ on the left, $10^{-7}$ in the middle and $10^{-15}$ on the right}
