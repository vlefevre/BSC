...
V_1 = pylab.loadtxt("tol_0_10_1_1_661",skiprows=1)
V_1_up = pylab.loadtxt("tol_0_up_10_1_1_661",skiprows=1)
...
fig.tight_layout()
pylab.savefig('convergence_10_1_1_661.pdf')
pylab.clf()
...
pylab.legend(loc=2)
pylab.savefig("time_convergence_10_1_1_661.pdf")
