...
V_1 = pylab.loadtxt("tol_0_5_5_5_444",skiprows=1)
V_1_up = pylab.loadtxt("tol_0_up_5_5_5_444",skiprows=1)
...
fig.tight_layout()
pylab.savefig('convergence_5_5_5_444.pdf')
pylab.clf()
...
pylab.legend(loc=2)
pylab.savefig("time_convergence_5_5_5_444.pdf")
