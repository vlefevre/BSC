...
V_1 = pylab.loadtxt("tol_0_5_5_5_80",skiprows=1)
V_1_fast4 = pylab.loadtxt("tol_0_fast_5_5_5_80",skiprows=1)
V_1_up = pylab.loadtxt("tol_0_up_5_5_5_80",skiprows=1)
...
fig.tight_layout()
pylab.savefig('convergence_fast_5_5_5.pdf')
pylab.clf()
...
pylab.legend(loc=2)
pylab.savefig("time_convergence_fast_5_5_5.pdf")
