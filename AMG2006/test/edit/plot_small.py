...
V_2 = pylab.loadtxt("tol_0_V_2_small",skiprows=1)
V_3 = pylab.loadtxt("tol_0_V_3_small",skiprows=1)
V_10 = pylab.loadtxt("tol_0_V_10_small",skiprows=1)
W_1 = pylab.loadtxt("tol_0_W_small",skiprows=1)
W_2 = pylab.loadtxt("tol_0_W_2_small",skiprows=1)
W_3 = pylab.loadtxt("tol_0_W_3_small",skiprows=1)
W_10 = pylab.loadtxt("tol_0_W_10_small",skiprows=1)
...
fig.tight_layout()
pylab.savefig('convergence_1_small.pdf')
pylab.clf()



time_V_1 = pylab.loadtxt("mi_inf_V_small",skiprows=1)
time_V_2 = pylab.loadtxt("mi_inf_V_2_small",skiprows=1)
time_V_3 = pylab.loadtxt("mi_inf_V_3_small",skiprows=1)
time_V_10 = pylab.loadtxt("mi_inf_V_10_small",skiprows=1)
time_W_1 = pylab.loadtxt("mi_inf_W_small",skiprows=1)
time_W_2 = pylab.loadtxt("mi_inf_W_2_small",skiprows=1)
time_W_3 = pylab.loadtxt("mi_inf_W_3_small",skiprows=1)
time_W_10 = pylab.loadtxt("mi_inf_W_10_small",skiprows=1)
...
pylab.ylabel("time")
pylab.legend()
pylab.savefig("time_convergence_small.pdf")
