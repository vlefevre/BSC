...
V_1 = pylab.loadtxt("tol_0_orig_180_64",skiprows=1)
V_1_up = pylab.loadtxt("tol_0_up_180_64",skiprows=1)
...
fig.tight_layout()
pylab.savefig('convergence_64_180.pdf')
pylab.clf()
...
pylab.ylim([0,3])
pylab.legend()
pylab.savefig("time_convergence_64_180.pdf")
