                        ...
                        int                  **CF_marker_ptr)
{
   ...
   int_buf_data = hypre_CTAlloc(int, hypre_ParCSRCommPkgSendMapStart(comm_pkg,
                                                num_sends));
   buf_data = hypre_CTAlloc(float, hypre_ParCSRCommPkgSendMapStart(comm_pkg,
                                                num_sends));
   ...
   measure_array = hypre_CTAlloc(float, num_variables+num_cols_offd);
