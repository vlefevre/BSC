                       ...
                       HYPRE_ParVector Hx      )
{
   ...
   float *x_data = hypre_VectorData(hypre_ParVectorLocalVector(x));
   float *y_data = hypre_VectorData(hypre_ParVectorLocalVector(y));
   float *A_data = hypre_CSRMatrixData(hypre_ParCSRMatrixDiag(A));
