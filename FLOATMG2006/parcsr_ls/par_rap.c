 ...
 *--------------------------------------------------------------------------*/
   ...
   if (num_nonzeros)
   {
      ...
      RAP_ext_data = hypre_CTAlloc(float, num_nonzeros);
   }
...
#include "../utilities/hypre_smp_forloop.h"
   ...
   RAP_int_data = hypre_CTAlloc(float, RAP_size);
...
*/      
   ...
   if (RAP_diag_size)
   { 
      RAP_diag_data = hypre_CTAlloc(float, RAP_diag_size);
   ...
   if (RAP_offd_size)
   { 
        RAP_offd_data = hypre_CTAlloc(float, RAP_offd_size);
