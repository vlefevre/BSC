...
int HYPRE_SchwarzSetRelaxWeight(HYPRE_Solver solver, float relax_weight);
...
int HYPRE_ParCSRHybridGetFinalRelativeResidualNorm(HYPRE_Solver  solver,                                                   float             *norm); 
