...
/* csr_matvec.c */
int hypre_CSRMatrixMatvec ( float alpha , hypre_CSRMatrix *A , hypre_Vector *x , float beta , hypre_Vector *y );
int hypre_CSRMatrixMatvecT ( float alpha , hypre_CSRMatrix *A , hypre_Vector *x , float beta , hypre_Vector *y );
int hypre_CSRMatrixMatvec_FF ( float alpha , hypre_CSRMatrix *A , hypre_Vector *x , float beta , hypre_Vector *y , int *CF_marker_x , int *CF_marker_y , int fpt );
...
int hypre_SeqVectorSetConstantValues ( hypre_Vector *v , float value );
...
int hypre_SeqVectorScale ( float alpha , hypre_Vector *y );
int hypre_SeqVectorAxpy ( float alpha , hypre_Vector *x , hypre_Vector *y );
float hypre_SeqVectorInnerProd ( hypre_Vector *x , hypre_Vector *y );
float hypre_VectorSumElts ( hypre_Vector *vector );
