...
typedef struct hypre_SStructVector_struct
{
  ...
  /* GEC10020902 pointer to big chunk of memory and auxiliary information   */
   ...
   float                  *data;        /* GEC1002 pointer to chunk data  */
...
int HYPRE_SStructMatrixSetValues ( HYPRE_SStructMatrix matrix , int part , int *index , int var , int nentries , int *entries , float *values );
int HYPRE_SStructMatrixSetBoxValues ( HYPRE_SStructMatrix matrix , int part , int *ilower , int *iupper , int var , int nentries , int *entries , float *values );
int HYPRE_SStructMatrixGetValues ( HYPRE_SStructMatrix matrix , int part , int *index , int var , int nentries , int *entries , float *values );
int HYPRE_SStructMatrixGetBoxValues ( HYPRE_SStructMatrix matrix , int part , int *ilower , int *iupper , int var , int nentries , int *entries , float *values );
int HYPRE_SStructMatrixAddToValues ( HYPRE_SStructMatrix matrix , int part , int *index , int var , int nentries , int *entries , float *values );
int HYPRE_SStructMatrixAddToBoxValues ( HYPRE_SStructMatrix matrix , int part , int *ilower , int *iupper , int var , int nentries , int *entries , float *values );
...
int HYPRE_SStructMatrixMatvec ( float alpha , HYPRE_SStructMatrix A , HYPRE_SStructVector x , float beta , HYPRE_SStructVector y );
...
int HYPRE_SStructVectorSetValues ( HYPRE_SStructVector vector , int part , int *index , int var , float *value );
int HYPRE_SStructVectorSetBoxValues ( HYPRE_SStructVector vector , int part , int *ilower , int *iupper , int var , float *values );
int HYPRE_SStructVectorAddToValues ( HYPRE_SStructVector vector , int part , int *index , int var , float *value );
int HYPRE_SStructVectorAddToBoxValues ( HYPRE_SStructVector vector , int part , int *ilower , int *iupper , int var , float *values );
int HYPRE_SStructVectorAssemble ( HYPRE_SStructVector vector );
int HYPRE_SStructVectorGather ( HYPRE_SStructVector vector );
int HYPRE_SStructVectorGetValues ( HYPRE_SStructVector vector , int part , int *index , int var , float *value );
int HYPRE_SStructVectorGetBoxValues ( HYPRE_SStructVector vector , int part , int *ilower , int *iupper , int var , float *values );
int HYPRE_SStructVectorSetConstantValues ( HYPRE_SStructVector vector , float value );
...
int HYPRE_SStructVectorScale ( float alpha , HYPRE_SStructVector y );
int HYPRE_SStructInnerProd ( HYPRE_SStructVector x , HYPRE_SStructVector y , float *result );
int HYPRE_SStructAxpy ( float alpha , HYPRE_SStructVector x , HYPRE_SStructVector y );

/* sstruct_axpy.c */
int hypre_SStructPAxpy ( float alpha , hypre_SStructPVector *px , hypre_SStructPVector *py );
int hypre_SStructAxpy ( float alpha , hypre_SStructVector *x , hypre_SStructVector *y );
...
/* sstruct_innerprod.c */
int hypre_SStructPInnerProd ( hypre_SStructPVector *px , hypre_SStructPVector *py , float *presult_ptr );
int hypre_SStructInnerProd ( hypre_SStructVector *x , hypre_SStructVector *y , float *result_ptr );
...
int hypre_SStructPMatrixSetValues ( hypre_SStructPMatrix *pmatrix , hypre_Index index , int var , int nentries , int *entries , float *values , int add_to );
int hypre_SStructPMatrixSetBoxValues ( hypre_SStructPMatrix *pmatrix , hypre_Index ilower , hypre_Index iupper , int var , int nentries , int *entries , float *values , int add_to );
...
int hypre_SStructUMatrixSetValues ( hypre_SStructMatrix *matrix , int part , hypre_Index index , int var , int nentries , int *entries , float *values , int add_to );
int hypre_SStructUMatrixSetBoxValues ( hypre_SStructMatrix *matrix , int part , hypre_Index ilower , hypre_Index iupper , int var , int nentries , int *entries , float *values , int add_to );
...
int hypre_SStructPMatvecCompute ( void *pmatvec_vdata , float alpha , hypre_SStructPMatrix *pA , hypre_SStructPVector *px , float beta , hypre_SStructPVector *py );
int hypre_SStructPMatvecDestroy ( void *pmatvec_vdata );
int hypre_SStructPMatvec ( float alpha , hypre_SStructPMatrix *pA , hypre_SStructPVector *px , float beta , hypre_SStructPVector *py );
...
int hypre_SStructMatvecCompute ( void *matvec_vdata , float alpha , hypre_SStructMatrix *A , hypre_SStructVector *x , float beta , hypre_SStructVector *y );
int hypre_SStructMatvecDestroy ( void *matvec_vdata );
int hypre_SStructMatvec ( float alpha , hypre_SStructMatrix *A , hypre_SStructVector *x , float beta , hypre_SStructVector *y );

/* sstruct_overlap_innerprod.c */
int hypre_SStructPOverlapInnerProd ( hypre_SStructPVector *px , hypre_SStructPVector *py , float *presult_ptr );
int hypre_SStructOverlapInnerProd ( hypre_SStructVector *x , hypre_SStructVector *y , float *result_ptr );

/* sstruct_scale.c */
int hypre_SStructPScale ( float alpha , hypre_SStructPVector *py );
int hypre_SStructScale ( float alpha , hypre_SStructVector *y );
...
int hypre_SStructPVectorSetValues ( hypre_SStructPVector *pvector , hypre_Index index , int var , float *value , int add_to );
int hypre_SStructPVectorSetBoxValues ( hypre_SStructPVector *pvector , hypre_Index ilower , hypre_Index iupper , int var , float *values , int add_to );
int hypre_SStructPVectorAssemble ( hypre_SStructPVector *pvector );
int hypre_SStructPVectorGather ( hypre_SStructPVector *pvector );
int hypre_SStructPVectorGetValues ( hypre_SStructPVector *pvector , hypre_Index index , int var , float *value );
int hypre_SStructPVectorGetBoxValues ( hypre_SStructPVector *pvector , hypre_Index ilower , hypre_Index iupper , int var , float *values );
int hypre_SStructPVectorSetConstantValues ( hypre_SStructPVector *pvector , float value );
