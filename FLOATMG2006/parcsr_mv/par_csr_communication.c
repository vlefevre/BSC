                               ...
                               void          *recv_data )
{
    ...
    *		and recv_data to be floats, recv_vec_starts and 
    ...
    *		and recv_data to be floats, recv_vec_starts and 
    *		send_map_starts need to be set in comm_pkg.
    * job = 11: similar to job = 1, but exchanges data of type int (not float),
    *		requires send_data and recv_data to be ints
    *		recv_vec_starts and send_map_starts need to be set in comm_pkg.
    * job = 12: similar to job = 1, but exchanges data of type int (not float),
    *		requires send_data and recv_data to be ints
    *		recv_vec_starts and send_map_starts need to be set in comm_pkg.
    * job = 21: similar to job = 1, but exchanges data of type int (not float),
    *		requires send_data and recv_data to be long longs
    *		recv_vec_starts and send_map_starts need to be set in comm_pkg.
    * job = 22: similar to job = 1, but exchanges data of type int (not float),
    *		requires send_data and recv_data to be long longs
    *		recv_vec_starts and send_map_starts need to be set in comm_pkg.
   ...
   case  1:
   {
	float *d_send_data = (float *) send_data;
	float *d_recv_data = (float *) recv_data;
