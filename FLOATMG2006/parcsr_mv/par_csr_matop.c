				     ...
				     hypre_ParCSRMatrix  *B)
{
   ...
   float          *B_diag_data = hypre_CSRMatrixData(B_diag);
   ...
   float          *B_offd_data = hypre_CSRMatrixData(B_offd);
   ...
   float          *B_ext_diag_data;
   int             *B_ext_diag_i;
   int             *B_ext_diag_j;
   int              B_ext_diag_size;

   float          *B_ext_offd_data;
   int             *B_ext_offd_i;
   int             *B_ext_offd_j;
   int              B_ext_offd_size;
   ...
   if (B_ext_diag_size)
   {
      ...
      B_ext_diag_data = hypre_CTAlloc(float, B_ext_diag_size);
   }
   if (B_ext_offd_size)
   {
      B_ext_offd_j = hypre_CTAlloc(int, B_ext_offd_size);
      B_ext_offd_data = hypre_CTAlloc(float, B_ext_offd_size);
   }
 ...
 *--------------------------------------------------------------------------*/
   ...
   if (data) B_int_data = hypre_CTAlloc(float, num_nonzeros);
 ...
 *--------------------------------------------------------------------------*/
   ...
   if (data) 
      B_ext_data = hypre_CTAlloc(float, num_nonzeros);
