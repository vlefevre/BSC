...
int HYPRE_ParCSRMatrixGetRow ( HYPRE_ParCSRMatrix matrix , HYPRE_BigInt row , int *size , HYPRE_BigInt **col_ind , float **values );
int HYPRE_ParCSRMatrixRestoreRow ( HYPRE_ParCSRMatrix matrix , HYPRE_BigInt row , int *size , HYPRE_BigInt **col_ind , float **values );
...
int HYPRE_ParCSRMatrixMatvec ( float alpha , HYPRE_ParCSRMatrix A , HYPRE_ParVector x , float beta , HYPRE_ParVector y );
int HYPRE_ParCSRMatrixMatvecT ( float alpha , HYPRE_ParCSRMatrix A , HYPRE_ParVector x , float beta , HYPRE_ParVector y );
...
int HYPRE_ParVectorSetConstantValues ( HYPRE_ParVector vector , float value );
...
int HYPRE_ParVectorScale ( float value , HYPRE_ParVector x );
int HYPRE_ParVectorAxpy ( float alpha , HYPRE_ParVector x , HYPRE_ParVector y );
int HYPRE_ParVectorInnerProd ( HYPRE_ParVector x , HYPRE_ParVector y , float *prod );
...
int hypre_LocateAssummedPartition ( HYPRE_BigInt row_start , HYPRE_BigInt row_end , HYPRE_BigInt global_num_rows , hypre_IJAssumedPart *part , int myid );
...
int hypre_GetAssumedPartitionProcFromRow ( HYPRE_BigInt row , HYPRE_BigInt global_num_rows , int *proc_id );
int hypre_GetAssumedPartitionRowRange ( int proc_id , HYPRE_BigInt global_num_rows , HYPRE_BigInt *row_start , HYPRE_BigInt *row_end );
...
int hypre_BuildCSRMatrixMPIDataType ( int num_nonzeros , int num_rows , float *a_data , int *a_i , int *a_j , MPI_Datatype *csr_matrix_datatype );
int hypre_BuildCSRJDataType ( int num_nonzeros , float *a_data , int *a_j , MPI_Datatype *csr_jdata_datatype );
...
void hypre_ParMatScaleDiagInv_F ( hypre_ParCSRMatrix *C , hypre_ParCSRMatrix *A , float weight , int *CF_marker );
...
int hypre_ParCSRMatrixGetLocalRange ( hypre_ParCSRMatrix *matrix , HYPRE_BigInt *row_start , HYPRE_BigInt *row_end , HYPRE_BigInt *col_start , HYPRE_BigInt *col_end );
int hypre_ParCSRMatrixGetRow ( hypre_ParCSRMatrix *mat , HYPRE_BigInt row , int *size , HYPRE_BigInt **col_ind , float **values );
int hypre_ParCSRMatrixRestoreRow ( hypre_ParCSRMatrix *matrix , HYPRE_BigInt row , int *size , HYPRE_BigInt **col_ind , float **values );
...
int hypre_ParCSRMatrixMatvec ( float alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , float beta , hypre_ParVector *y );
int hypre_ParCSRMatrixMatvecT ( float alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , float beta , hypre_ParVector *y );
int hypre_ParCSRMatrixMatvec_FF ( float alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , float beta , hypre_ParVector *y , int *CF_marker , int fpt );
...
int hypre_ParVectorPrint ( hypre_ParVector *vector , const char *file_name );
int hypre_ParVectorSetConstantValues ( hypre_ParVector *v , float value );
int hypre_ParVectorSetRandomValues ( hypre_ParVector *v , int seed );
int hypre_ParVectorCopy ( hypre_ParVector *x , hypre_ParVector *y );
hypre_ParVector *hypre_ParVectorCloneShallow ( hypre_ParVector *x );
int hypre_ParVectorScale ( float alpha , hypre_ParVector *y );
int hypre_ParVectorAxpy ( float alpha , hypre_ParVector *x , hypre_ParVector *y );
float hypre_ParVectorInnerProd ( hypre_ParVector *x , hypre_ParVector *y );
...
float hypre_ParVectorLocalSumElts ( hypre_ParVector *vector );
