...
typedef struct
{
  ...
  int (*Matvec)( void *matvec_data , float alpha , void *A , void *x , float beta , void *y );
...
typedef struct
{
   ...
   int    (*MatvecT)       ( void *matvec_data, float alpha, void *A,
                             void *x, float beta, void *y );
   int    (*MatvecDestroy) ( void *matvec_data );
   float (*InnerProd)     ( void *x, void *y );
   int    (*CopyVector)    ( void *x, void *y );
...
/* bicgstab.c */
hypre_BiCGSTABFunctions *hypre_BiCGSTABFunctionsCreate ( void *(*CreateVector )(void *vvector ), int (*DestroyVector )(void *vvector ), void *(*MatvecCreate )(void *A ,void *x ), int (*Matvec )(void *matvec_data ,float alpha ,void *A ,void *x ,float beta ,void *y ), int (*MatvecDestroy )(void *matvec_data ), float (*InnerProd )(void *x ,void *y ), int (*CopyVector )(void *x ,void *y ), int (*ScaleVector )(float alpha ,void *x ), int (*Axpy )(float alpha ,void *x ,void *y ), int (*CommInfo )(void *A ,int *my_id ,int *num_procs ), int (*PrecondSetup )(void *vdata ,void *A ,void *b ,void *x ), int (*Precond )(void *vdata ,void *A ,void *b ,void *x ));
...
int hypre_BiCGSTABSetTol ( void *bicgstab_vdata , float tol );
int hypre_BiCGSTABSetConvergenceFactorTol ( void *bicgstab_vdata , float cf_tol );
...
int hypre_BiCGSTABGetFinalRelativeResidualNorm ( void *bicgstab_vdata , float *relative_residual_norm );
int hypre_BiCGSTABGetResidual ( void *bicgstab_vdata , void **residual );

/* cgnr.c */
hypre_CGNRFunctions *hypre_CGNRFunctionsCreate ( int (*CommInfo )(void *A ,int *my_id ,int *num_procs ), void *(*CreateVector )(void *vector ), int (*DestroyVector )(void *vector ), void *(*MatvecCreate )(void *A ,void *x ), int (*Matvec )(void *matvec_data ,float alpha ,void *A ,void *x ,float beta ,void *y ), int (*MatvecT )(void *matvec_data ,float alpha ,void *A ,void *x ,float beta ,void *y ), int (*MatvecDestroy )(void *matvec_data ), float (*InnerProd )(void *x ,void *y ), int (*CopyVector )(void *x ,void *y ), int (*ClearVector )(void *x ), int (*ScaleVector )(float alpha ,void *x ), int (*Axpy )(float alpha ,void *x ,void *y ), int (*PrecondSetup )(void *vdata ,void *A ,void *b ,void *x ), int (*Precond )(void *vdata ,void *A ,void *b ,void *x ), int (*PrecondT )(void *vdata ,void *A ,void *b ,void *x ));
...
int hypre_CGNRSetTol ( void *cgnr_vdata , float tol );
...
int hypre_CGNRGetFinalRelativeResidualNorm ( void *cgnr_vdata , float *relative_residual_norm );

/* gmres.c */
hypre_GMRESFunctions *hypre_GMRESFunctionsCreate ( char *(*CAlloc )(int count ,int elt_size ), int (*Free )(char *ptr ), int (*CommInfo )(void *A ,int *my_id ,int *num_procs ), void *(*CreateVector )(void *vector ), void *(*CreateVectorArray )(int size ,void *vectors ), int (*DestroyVector )(void *vector ), void *(*MatvecCreate )(void *A ,void *x ), int (*Matvec )(void *matvec_data ,float alpha ,void *A ,void *x ,float beta ,void *y ), int (*MatvecDestroy )(void *matvec_data ), float (*InnerProd )(void *x ,void *y ), int (*CopyVector )(void *x ,void *y ), int (*ClearVector )(void *x ), int (*ScaleVector )(float alpha ,void *x ), int (*Axpy )(float alpha ,void *x ,void *y ), int (*PrecondSetup )(void *vdata ,void *A ,void *b ,void *x ), int (*Precond )(void *vdata ,void *A ,void *b ,void *x ));
...
int hypre_GMRESSetTol ( void *gmres_vdata , float tol );
int hypre_GMRESGetTol ( void *gmres_vdata , float *tol );
int hypre_GMRESSetConvergenceFactorTol ( void *gmres_vdata , float cf_tol );
int hypre_GMRESGetConvergenceFactorTol ( void *gmres_vdata , float *cf_tol );
...
int hypre_GMRESGetFinalRelativeResidualNorm ( void *gmres_vdata , float *relative_residual_norm );
...
int HYPRE_BiCGSTABSetTol ( HYPRE_Solver solver , float tol );
int HYPRE_BiCGSTABSetConvergenceFactorTol ( HYPRE_Solver solver , float cf_tol );
...
int HYPRE_BiCGSTABGetFinalRelativeResidualNorm ( HYPRE_Solver solver , float *norm );
...
int HYPRE_CGNRSetTol ( HYPRE_Solver solver , float tol );
...
int HYPRE_CGNRGetFinalRelativeResidualNorm ( HYPRE_Solver solver , float *norm );
...
int HYPRE_GMRESSetTol ( HYPRE_Solver solver , float tol );
int HYPRE_GMRESGetTol ( HYPRE_Solver solver , float *tol );
int HYPRE_GMRESSetConvergenceFactorTol ( HYPRE_Solver solver , float cf_tol );
int HYPRE_GMRESGetConvergenceFactorTol ( HYPRE_Solver solver , float *cf_tol );
...
int HYPRE_GMRESGetFinalRelativeResidualNorm ( HYPRE_Solver solver , float *norm );
...
int HYPRE_PCGSetTol ( HYPRE_Solver solver , float tol );
int HYPRE_PCGGetTol ( HYPRE_Solver solver , float *tol );
int HYPRE_PCGSetAbsoluteTolFactor ( HYPRE_Solver solver , float abstolf );
int HYPRE_PCGGetAbsoluteTolFactor ( HYPRE_Solver solver , float *abstolf );
int HYPRE_PCGSetConvergenceFactorTol ( HYPRE_Solver solver , float cf_tol );
int HYPRE_PCGGetConvergenceFactorTol ( HYPRE_Solver solver , float *cf_tol );
...
int HYPRE_PCGGetFinalRelativeResidualNorm ( HYPRE_Solver solver , float *norm );
int HYPRE_PCGGetResidual ( HYPRE_Solver solver , void **residual );

/* pcg.c */
hypre_PCGFunctions *hypre_PCGFunctionsCreate ( char *(*CAlloc )(int count ,int elt_size ), int (*Free )(char *ptr ), int (*CommInfo )(void *A ,int *my_id ,int *num_procs ), void *(*CreateVector )(void *vector ), int (*DestroyVector )(void *vector ), void *(*MatvecCreate )(void *A ,void *x ), int (*Matvec )(void *matvec_data ,float alpha ,void *A ,void *x ,float beta ,void *y ), int (*MatvecDestroy )(void *matvec_data ), float (*InnerProd )(void *x ,void *y ), int (*CopyVector )(void *x ,void *y ), int (*ClearVector )(void *x ), int (*ScaleVector )(float alpha ,void *x ), int (*Axpy )(float alpha ,void *x ,void *y ), int (*PrecondSetup )(void *vdata ,void *A ,void *b ,void *x ), int (*Precond )(void *vdata ,void *A ,void *b ,void *x ));
...
int hypre_PCGSetTol ( void *pcg_vdata , float tol );
int hypre_PCGGetTol ( void *pcg_vdata , float *tol );
int hypre_PCGSetAbsoluteTolFactor ( void *pcg_vdata , float atolf );
int hypre_PCGGetAbsoluteTolFactor ( void *pcg_vdata , float *atolf );
int hypre_PCGSetConvergenceFactorTol ( void *pcg_vdata , float cf_tol );
int hypre_PCGGetConvergenceFactorTol ( void *pcg_vdata , float *cf_tol );
...
int hypre_PCGGetFinalRelativeResidualNorm ( void *pcg_vdata , float *relative_residual_norm );
