...
typedef struct
{
   ...
   float **aux_data; /* contains collected data */
   ...
   float  *off_proc_data; /* contains corresponding data */
...
int hypre_IJMatrixGetValuesParCSR ( hypre_IJMatrix *matrix , int nrows , int *ncols , HYPRE_BigInt *rows , HYPRE_BigInt *cols , float *values );
int hypre_IJMatrixSetValuesParCSR ( hypre_IJMatrix *matrix , int nrows , int *ncols , const HYPRE_BigInt *rows , const HYPRE_BigInt *cols , const float *values );
int hypre_IJMatrixAddToValuesParCSR ( hypre_IJMatrix *matrix , int nrows , int *ncols , const HYPRE_BigInt *rows , const HYPRE_BigInt *cols , const float *values );
int hypre_IJMatrixAssembleParCSR ( hypre_IJMatrix *matrix );
int hypre_IJMatrixDestroyParCSR ( hypre_IJMatrix *matrix );
int hypre_IJMatrixAssembleOffProcValsParCSR ( hypre_IJMatrix *matrix , int off_proc_i_indx , int max_off_proc_elmts , int current_num_elmts , HYPRE_BigInt *off_proc_i , HYPRE_BigInt *off_proc_j , float *off_proc_data );
...
int hypre_IJVectorSetValuesPar ( hypre_IJVector *vector , int num_values , const HYPRE_BigInt *indices , const float *values );
int hypre_IJVectorAddToValuesPar ( hypre_IJVector *vector , int num_values , const HYPRE_BigInt *indices , const float *values );
int hypre_IJVectorAssemblePar ( hypre_IJVector *vector );
int hypre_IJVectorGetValuesPar ( hypre_IJVector *vector , int num_values , const HYPRE_BigInt *indices , float *values );
int hypre_IJVectorAssembleOffProcValsPar ( hypre_IJVector *vector , int max_off_proc_elmts , int current_num_elmts , HYPRE_BigInt *off_proc_i , float *off_proc_data );
...
int HYPRE_IJMatrixSetValues ( HYPRE_IJMatrix matrix , int nrows , int *ncols , const HYPRE_BigInt *rows , const HYPRE_BigInt *cols , const float *values );
int HYPRE_IJMatrixAddToValues ( HYPRE_IJMatrix matrix , int nrows , int *ncols , const HYPRE_BigInt *rows , const HYPRE_BigInt *cols , const float *values );
...
int HYPRE_IJMatrixGetValues ( HYPRE_IJMatrix matrix , int nrows , int *ncols , HYPRE_BigInt *rows , HYPRE_BigInt *cols , float *values );
...
int HYPRE_IJVectorSetValues ( HYPRE_IJVector vector , int nvalues , const HYPRE_BigInt *indices , const float *values );
int HYPRE_IJVectorAddToValues ( HYPRE_IJVector vector , int nvalues , const HYPRE_BigInt *indices , const float *values );
int HYPRE_IJVectorAssemble ( HYPRE_IJVector vector );
int HYPRE_IJVectorGetValues ( HYPRE_IJVector vector , int nvalues , const HYPRE_BigInt *indices , float *values );
