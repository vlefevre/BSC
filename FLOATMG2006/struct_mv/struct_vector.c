...
hypre_StructVectorInitialize( hypre_StructVector *vector )
{
   ...
   data = hypre_SharedCTAlloc(float, hypre_StructVectorDataSize(vector));
...
hypre_StructVectorAssemble( hypre_StructVector *vector )
{
   ...
   if (sum_OffProcAdd)
   {
      ...
      data= hypre_CTAlloc(float, hypre_StructVectorDataSize(vector));
...
int 
hypre_StructVectorScaleValues( hypre_StructVector *vector, float factor )
{
   int               ierr = 0;
