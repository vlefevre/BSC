...
#define vol_cbrt(vol) (int) pow((float)(vol), 1. / 3.) 
...
#define hypre_ChunkLoopExternalSetup(hypre__nx, hypre__ny, hypre__nz)\
   ...
   target_vol    = hypre_min(hypre_max((hypre__nx * hypre__ny * hypre__nz) / CHUNK_GOAL,\
                           MIN_VOL), MAX_VOL);\
   cbrt_tar_vol  = (int) (pow ((float)target_vol, 1./3.));\
   ...
   sqrt_tar_area = (int) (sqrt((float)target_area));\
...
{
   int                   proc;
   int                   bufsize;     /* message buffer size (in floats) */
   int                   num_entries;
...
typedef struct hypre_CommPkg_struct
{
   ...
   hypre_Index       send_stride;
   hypre_Index       recv_stride;
   int               send_bufsize; /* total send buffer size (in floats) */
   int               recv_bufsize; /* total recv buffer size (in floats) */
...
#define hypre_floatBoxVolume(box) \
   ((float) hypre_BoxSizeX(box) * (float) hypre_BoxSizeY(box) * (float) hypre_BoxSizeZ(box))
...
int hypre_APFindMyBoxesInRegions ( hypre_BoxArray *region_array , hypre_BoxArray *my_box_array , int **p_count_array , float **p_vol_array );
int hypre_APGetAllBoxesInRegions ( hypre_BoxArray *region_array , hypre_BoxArray *my_box_array , int **p_count_array , float **p_vol_array , MPI_Comm comm );
int hypre_APShrinkRegions ( hypre_BoxArray *region_array , hypre_BoxArray *my_box_array , MPI_Comm comm );
int hypre_APPruneRegions ( hypre_BoxArray *region_array , int **p_count_array , float **p_vol_array );
int hypre_APRefineRegionsByVol ( hypre_BoxArray *region_array , float *vol_array , int max_regions , float gamma , int dim , int *return_code , MPI_Comm comm );
int hypre_StructAssumedPartitionCreate ( int dim , hypre_Box *bounding_box , float global_boxes_size , int global_num_boxes , hypre_BoxArray *local_boxes , int *local_boxnums , int max_regions , int max_refinements , float gamma , MPI_Comm comm , hypre_StructAssumedPart **p_assumed_partition );
...
int hypre_InitializeIndtComputations ( hypre_ComputePkg *compute_pkg , float *data , hypre_CommHandle **comm_handle_ptr );
...
int HYPRE_StructMatrixSetValues ( HYPRE_StructMatrix matrix , int *grid_index , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixSetBoxValues ( HYPRE_StructMatrix matrix , int *ilower , int *iupper , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixGetBoxValues ( HYPRE_StructMatrix matrix , int *ilower , int *iupper , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixSetConstantValues ( HYPRE_StructMatrix matrix , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixAddToValues ( HYPRE_StructMatrix matrix , int *grid_index , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixAddToBoxValues ( HYPRE_StructMatrix matrix , int *ilower , int *iupper , int num_stencil_indices , int *stencil_indices , float *values );
int HYPRE_StructMatrixAddToConstantValues ( HYPRE_StructMatrix matrix , int num_stencil_indices , int *stencil_indices , float *values );
...
int HYPRE_StructMatrixMatvec ( float alpha , HYPRE_StructMatrix A , HYPRE_StructVector x , float beta , HYPRE_StructVector y );
...
int HYPRE_StructVectorSetValues ( HYPRE_StructVector vector , int *grid_index , float values );
int HYPRE_StructVectorSetBoxValues ( HYPRE_StructVector vector , int *ilower , int *iupper , float *values );
int HYPRE_StructVectorAddToValues ( HYPRE_StructVector vector , int *grid_index , float values );
int HYPRE_StructVectorAddToBoxValues ( HYPRE_StructVector vector , int *ilower , int *iupper , float *values );
int HYPRE_StructVectorScaleValues ( HYPRE_StructVector vector , float factor );
int HYPRE_StructVectorGetValues ( HYPRE_StructVector vector , int *grid_index , float *values_ptr );
int HYPRE_StructVectorGetBoxValues ( HYPRE_StructVector vector , int *ilower , int *iupper , float *values );
...
int HYPRE_StructVectorSetConstantValues ( HYPRE_StructVector vector , float values );
...
/* struct_axpy.c */
int hypre_StructAxpy ( float alpha , hypre_StructVector *x , hypre_StructVector *y );
...
int hypre_InitializeCommunication ( hypre_CommPkg *comm_pkg , float *send_data , float *recv_data , hypre_CommHandle **comm_handle_ptr );
int hypre_FinalizeCommunication ( hypre_CommHandle *comm_handle );
int hypre_ExchangeLocalData ( hypre_CommPkg *comm_pkg , float *send_data , float *recv_data );
int hypre_CommPkgDestroy ( hypre_CommPkg *comm_pkg );
...
/* struct_innerprod.c */
float hypre_StructInnerProd ( hypre_StructVector *x , hypre_StructVector *y );

/* struct_io.c */
int hypre_PrintBoxArrayData ( FILE *file , hypre_BoxArray *box_array , hypre_BoxArray *data_space , int num_values , float *data );
int hypre_PrintCCVDBoxArrayData ( FILE *file , hypre_BoxArray *box_array , hypre_BoxArray *data_space , int num_values , int center_rank , int stencil_size , int *symm_elements , float *data );
int hypre_PrintCCBoxArrayData ( FILE *file , hypre_BoxArray *box_array , hypre_BoxArray *data_space , int num_values , float *data );
int hypre_ReadBoxArrayData ( FILE *file , hypre_BoxArray *box_array , hypre_BoxArray *data_space , int num_values , float *data );
int hypre_ReadBoxArrayData_CC ( FILE *file , hypre_BoxArray *box_array , hypre_BoxArray *data_space , int stencil_size , int real_stencil_size , int constant_coefficient , float *data );

/* struct_matrix.c */
float *hypre_StructMatrixExtractPointerByIndex ( hypre_StructMatrix *matrix , int b , hypre_Index index );
...
int hypre_StructMatrixInitializeData ( hypre_StructMatrix *matrix , float *data );
int hypre_StructMatrixInitialize ( hypre_StructMatrix *matrix );
int hypre_StructMatrixSetValues ( hypre_StructMatrix *matrix , hypre_Index grid_index , int num_stencil_indices , int *stencil_indices , float *values , int action );
int hypre_StructMatrixSetBoxValues ( hypre_StructMatrix *matrix , hypre_Box *value_box , int num_stencil_indices , int *stencil_indices , float *values , int action );
int hypre_StructMatrixSetConstantValues ( hypre_StructMatrix *matrix , int num_stencil_indices , int *stencil_indices , float *values , int action );
int hypre_StructMatrixAssemble ( hypre_StructMatrix *matrix );
int hypre_StructMatrixSetNumGhost ( hypre_StructMatrix *matrix , int *num_ghost );
...
int hypre_StructMatvecCompute ( void *matvec_vdata , float alpha , hypre_StructMatrix *A , hypre_StructVector *x , float beta , hypre_StructVector *y );
int hypre_StructMatvecCC0 ( float alpha , hypre_StructMatrix *A , hypre_StructVector *x , hypre_StructVector *y , hypre_BoxArrayArray *compute_box_aa , hypre_IndexRef stride );
int hypre_StructMatvecCC1 ( float alpha , hypre_StructMatrix *A , hypre_StructVector *x , hypre_StructVector *y , hypre_BoxArrayArray *compute_box_aa , hypre_IndexRef stride );
int hypre_StructMatvecCC2 ( float alpha , hypre_StructMatrix *A , hypre_StructVector *x , hypre_StructVector *y , hypre_BoxArrayArray *compute_box_aa , hypre_IndexRef stride );
int hypre_StructMatvecDestroy ( void *matvec_vdata );
int hypre_StructMatvec ( float alpha , hypre_StructMatrix *A , hypre_StructVector *x , float beta , hypre_StructVector *y );

/* struct_overlap_innerprod.c */
float hypre_StructOverlapInnerProd ( hypre_StructVector *x , hypre_StructVector *y );

/* struct_scale.c */
int hypre_StructScale ( float alpha , hypre_StructVector *y );
...
int hypre_StructVectorInitializeData ( hypre_StructVector *vector , float *data );
int hypre_StructVectorInitialize ( hypre_StructVector *vector );
int hypre_StructVectorSetValues ( hypre_StructVector *vector , hypre_Index grid_index , float values , int add_to );
int hypre_StructVectorSetBoxValues ( hypre_StructVector *vector , hypre_Box *value_box , float *values , int add_to );
int hypre_StructVectorGetValues ( hypre_StructVector *vector , hypre_Index grid_index , float *values_ptr );
int hypre_StructVectorGetBoxValues ( hypre_StructVector *vector , hypre_Box *value_box , float *values );
int hypre_StructVectorSetNumGhost ( hypre_StructVector *vector , int *num_ghost );
int hypre_StructVectorAssemble ( hypre_StructVector *vector );
int hypre_StructVectorCopy ( hypre_StructVector *x , hypre_StructVector *y );
int hypre_StructVectorSetConstantValues ( hypre_StructVector *vector , float values );
int hypre_StructVectorSetFunctionValues ( hypre_StructVector *vector , float (*fcn )());
int hypre_StructVectorClearGhostValues ( hypre_StructVector *vector );
...
int hypre_StructVectorMaxValue ( hypre_StructVector *vector , float *max_value , int *max_index , hypre_Index max_xyz_index );
