...
float hypre_MPI_Wtime( void );
float hypre_MPI_Wtick( void );
...
float *hypre_IncrementSharedDataPtr( float *ptr , int size );
...
/* timer.c */
float time_getWallclockSeconds( void );
float time_getCPUSeconds( void );
float time_get_wallclock_seconds_( void );
float time_get_cpu_seconds_( void );
...
int hypre_PrintTiming( const char *heading , float *wall_time_ptr, MPI_Comm comm );
...
/* qsplit.c */
int hypre_DoubleQuickSplit ( float *values , int *indices , int list_length , int NumberKept );

/* hypre_qsort.c */
void swap ( int *v , int i , int j );
void swap2 ( int *v , float *w , int i , int j );
...
void qsort1 ( int *v , float *w , int left , int right );
void hypre_qsort2i ( int *v , int *w , int left , int right );
void hypre_qsort2 ( int *v , float *w , int left , int right );
