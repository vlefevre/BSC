...
Multi-grid solvers typically consist of three components: The \textit{Relaxation},
...
\begin{itemize}
    ...
    \item We propose a new cycle configuration and show that it is more
        ...
        %We stress that we present only a few results because of lack of space
        %but more measures were performed (and were consistent with the previous
        %ones) to conclude on the \textsc{Up}-strategy:

    \item We evaluate the impact of different floating-point precisions on the
        time-to-solution while reaching full accuracy on the final result.
