...
\begin{itemize}
    ...
    \item We propose a new cycle configuration and show that it is more
        efficient than the state-of-the-art configurations by up to 28.3\%. These measures are performed on a total of 9 different matrices, with number of MPI processes ranging from 1 to 64, ech MPI process having only 1 OpenMP thread.
