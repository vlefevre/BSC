...
\begin{frame}{Proof}
  The goal is to minimize the following function: $f(x_1,\dots,x_n) = \sum\limits_{i=1}^n x_i^2 - \sum\limits_{i=1}^{n-1} x_ix_{i+1}$, with $x_n \neq 0$.
...
\begin{center}
 \begin{tikzpicture}
      ...
      \draw[domain=0:5,smooth,variable=\x,black] plot ({\x},{\x});
    \end{tikzpicture}
