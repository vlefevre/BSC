...
\author{\IEEEauthorblockN{Leonardo Bautista-Gomez}
...
\begin{abstract}
  ...
  investigate whether it is possible or not to save time while keeping results that are not too far from their exact value. We first find a different cycle shape than the classic V-cycle used
