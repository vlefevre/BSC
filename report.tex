...
%     \includegraphics[width=\textwidth]{figs/3157_15.pdf}
   ...
   \begin{figure}
    \includegraphics[width=\textwidth]{figs/cost_3.pdf}
    \caption{}
    \label{fig.estimation1}
   \end{figure}
   \begin{figure}
    \includegraphics[width=\textwidth]{figs/cost_5.pdf}
    \caption{}
    \label{fig.estimation2}
   \end{figure}
   \begin{figure}
    \includegraphics[width=\textwidth]{figs/cost_7.pdf}
    \caption{}
    \label{fig.estimation3}
   \end{figure}
   \begin{figure}
    \includegraphics[width=\textwidth]{figs/cost_10.pdf}
    \caption{}
    \label{fig.estimation4}
   \end{figure}
   \begin{figure}
    \includegraphics[width=\textwidth]{figs/cost_15.pdf}
    \caption{}
   ...
   The table~\ref{tab.results1} presents the different estimated times (in time units where 1 time unit is a V-cycle at double precision)
